-- Corrige a listagem de especialistas ativos sem reescrever migration já aplicada.
-- Alguns perfis legados podem estar sem is_active preenchido; nesse caso,
-- devem ser tratados como ativos, desde que não estejam explicitamente false.
